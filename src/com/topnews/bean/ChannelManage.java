...
public class ChannelManage {
	...
	static {
		...
		defaultUserChannels.add(new ChannelItem(3, "深圳", 3, 1));
		...
		defaultUserChannels.add(new ChannelItem(20, "美文", 13, 0));
		defaultUserChannels.add(new ChannelItem(21, "养生", 14, 0));
		defaultUserChannels.add(new ChannelItem(22, "故事", 15, 0));
	}
